...
public class PaintingService {
    ...
    public PageResponse<PaintingResponse> filterByPriceRange(BigDecimal minPrice, BigDecimal maxPrice, int page, int size) {
    ...
    public void uploadImages(Long paintingId, MultipartFile[] files) {
        ...
        for (MultipartFile file : files) {
            String filePath = fileStorageService.storeFile(file, "paintings");
    ...
    @Transactional
    public void uploadCertificate(Long paintingId, MultipartFile file, String title, String issuer, LocalDate issueDate, String description) {
